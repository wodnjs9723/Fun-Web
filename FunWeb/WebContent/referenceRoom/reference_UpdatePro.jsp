...
<body>
	<%
		...
		String fname = null;
		String oldfileName = multi.getParameter("oldfile_name");
		while (e.hasMoreElements()) {
			...
			System.out.println(realpath+"\\"+oldfileName);
			/* // 업로드된 파일 삭제
			f.delete(); */
		}
		...
		String refer_subject = multi.getParameter("subject");
		String refer_file_name = multi.getFilesystemName(fname);
		String refer_content = multi.getParameter("content");
		int num = Integer.parseInt(multi.getParameter("num"));
		String pageNum = multi.getParameter("pageNum");
		ReferenceBean rb = new ReferenceBean();
		rb.setRefer_subject(refer_subject);
		rb.setRefer_file_name(refer_file_name);
		rb.setRefer_content(refer_content);
		rb.setNum(num);
		...
		response.sendRedirect("reference_content.jsp?num="+num+"&pageNum="+pageNum);
	%>
</body>
</html>